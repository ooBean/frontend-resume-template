...
export const languageMap: Record<Language, LanguageTexts> = {
  'zh-TW': {
    ...
    project3Link: '線上展示: http://bean.binballs.top/',
    project3Code: '程式碼: https://github.com/ooBean/portfolio-vue3-vite',
    project4Link: '線上展示: http://bean.binballs.top/salad-app/',
  ...
  'zh-CN': {
    ...
    project3Link: '线上展示: http://bean.binballs.top/',
    project3Code: '代码: https://github.com/ooBean/portfolio-vue3-vite',
    project4Link: '线上展示: http://bean.binballs.top/salad-app/',
  ...
  'en': {
    ...
    project3Link: 'Demo: http://bean.binballs.top/',
    project3Code: 'Code: https://github.com/ooBean/portfolio-vue3-vite',
    project4Link: 'Demo: http://bean.binballs.top/salad-app/',
