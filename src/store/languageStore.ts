...
export const languageMap: Record<Language, LanguageTexts> = {
  ...
  'en': {
    ...
    project1Point3: 'Ensured code reusability across different devices.',
    ...
    professionalSummaryText: 'Senior Frontend Engineer with 5 years of experience in large-scale JavaScript and Vue 2/3 projects. Skilled in TypeScript (1-2 years) and have practical experience with personal React projects. My skills include making websites faster, building with components, and adapting apps for Web, Mobile, and Mini-programs. I can lead complex tasks independently and deliver high-quality work on schedule in a remote setting.',
    coreSkillsText: 'JavaScript (5y), TypeScript (2y), Vue 2/3, React, Vite.',
