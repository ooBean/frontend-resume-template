...
export const languageMap: Record<Language, LanguageTexts> = {
  ...
  'en': {
    ...
    // 工作职责
    experience1Duty1: 'Oversaw the daily maintenance and continuous feature delivery for a high-traffic mini-program and its admin backend, consistently ensuring over 95% online service stability and a seamless user experience.',
    experience1Duty2: 'Engineered and implemented comprehensive frontend performance optimizations, which improved first-screen load speed by approx. 30% using advanced techniques like code splitting, lazy loading, and Web Workers.',
    experience2Duty1: 'Actively participated in the development of several core business modules, successfully reducing related bugs by 40% and improving overall development efficiency by 25% through rigorous component standardization.',
    experience2Duty2: 'Contributed to defining and optimizing frontend development processes and establishing new code standards, which significantly improved cross-functional team collaboration and long-term code consistency.',
    experience3Duty1: 'Led the core functional development for a complex enterprise-level management platform and its permission systems, successfully reducing redundant development by approximately 20% through strategic modularization.',
    experience3Duty2: 'Participated in the full-cycle optimization of the frontend development process, which directly resulted in demonstrably improved team collaboration efficiency and higher overall code quality and maintainability.',
    professionalSummaryText: '',
    coreSkillsText: '',
    stylingSkillsText: '',
    performanceSkillsText: '',
    visualizationSkillsText: '',
    remoteSkillsText: '',
    collaborationSkillsText: '',
    troubleshootingSkillsText: '',
    uiUxDescription: '',
    teamCollaborationDescription: '',
    codeQualityDescription: '',
    remoteWorkDescription: '',
    salaryRemoteWorkDescription: '',
    salaryProjectCooperationDescription: '',
    salaryFullTimeDescription: '',
    tencentProjectTech: '',
    tencentProjectLink: '',
    experience1Title: '',
    experience1Company: '',
